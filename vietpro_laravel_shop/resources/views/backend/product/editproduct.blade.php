                    ...
                    <form action="{{route('product.edit',['id'=>$products->id])}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row" style="margin-bottom:40px">
                                <div class="col-md-8">
                                    ...
                                    <label>Danh mục </label>
                                        ...
                                        <option value='{{$tl->id}}' @if($tl->id==$products->category_id){ selected="{{$tl->id}}"} @endif>{{$tl->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label>Mã sản phẩm</label>
                                        <input  type="text" name="code" disabled class="form-control" value="{{$products->code}}">
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Miêu tả</label>
                                    <textarea id="editor"  name="describe" style="width: 100%;height: 100px;">{{$products->description}}</textarea>
                                </div>

						...
						<div class="bootstrap-table">
							<div class="table-responsive">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="panel panel-blue">
												...
												<div class="panel-body">
													<strong><span class="glyphicon glyphicon-user" aria-hidden="true"></span> : Họ tên:  {{$order->full}}</strong> <br>
								...
								<div class="alert alert-primary" role="alert" align='right'>
										<a class="btn btn-success" href="{{route('orders.approve',['order_id'=> $order->id])}}" role="button">Đã xử lý</a>
									</div>
							</div>
						</div>
